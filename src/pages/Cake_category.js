...
export default function Cake_category() {
    return (
        <div>
        ...
        <ul className="breadcrumb">
            ...
            <div className="row">
                ...
                <a target="_blank" href="https://wa.me/919711140012?text=I%20would%20like%20to%20get%20something%20delivered">
                    <img src="images/cakedelight.jpg" alt="Store" className="img-responsive" />
                    <ul className="information">
                        <strong>The Cake Delight</strong>
                        <li className="store-address"><i className="fa fa-map-marker" aria-hidden="true"></i> Shop No.32, Behind SKV School, Aya Nagar, New Delhi</li>
        ...
        <div className="items-box">
                <a target="_blank" href="https://wa.me/919711140012?text=I%20would%20like%20to%20get%20something%20delivered">
                    <img src="images/chocosmith-img.jpg" alt="Store" className="img-responsive" />
                    <ul className="information">
                        <strong>ChocoSmith Gourmet Bakery</strong>
                        <li className="store-address"><i className="fa fa-map-marker" aria-hidden="true"></i> 13-15 LSC, Sheikh Sarai, Ph-II, New Delhi</li>
