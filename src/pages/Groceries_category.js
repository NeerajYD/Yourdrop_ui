...
export default function Groceries_category() {
    return (
        <div>
...
<ul class="breadcrumb">
                ...
                <a target="_blank" href="https://wa.me/919711140012?text=I%20would%20like%20to%20get%20something%20delivered">
                    <img src="images/saurav-store-img.jpg" alt="Store" class="img-responsive" />
                    <ul class="information">
                        <strong>Saurav Store</strong>
                        <li class="store-address"><i class="fa fa-map-marker" aria-hidden="true"></i> Shop No.9, DHC School Road, Khanpur, New Delhi</li>
