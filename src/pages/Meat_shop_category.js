...
export default function Meat_shop_category() {
    return (
        <div>
        ...
        <div className="container category-inner">
                ...
                <a target="_blank" href="https://wa.me/919711140012?text=I%20would%20like%20to%20get%20something%20delivered">
                    <img src="images/sherepunjab-img.jpg" alt="Store" className="img-responsive" />
                    <ul className="information">
                        <strong>Shere Punjab</strong>
                        <li className="store-address"><i className="fa fa-map-marker" aria-hidden="true"></i> L-Pocket Super Bazar, Sheikh Sarai, Ph-II, New Delhi</li>
